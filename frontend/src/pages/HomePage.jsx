...
const HomePage = () => {
  const {users  , getUsersProfiles , isLoadingUsers , subscribeToNewMatch , unsubscribeFromNewMatches }  = useMatchStore() ; 
  useEffect(() => {
    getUsersProfiles() ;   
  },[getUsersProfiles]) ;
  ...
  useEffect(() => {
    user && subscribeToNewMatch() ; 
  }, [subscribeToNewMatch, unsubscribeFromNewMatches , user ]) ;  
